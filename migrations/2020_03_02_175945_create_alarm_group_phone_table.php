...
class CreateAlarmGroupPhoneTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('alarm_group_phone', function (Blueprint $table) {
        ...
        HelpersForMigration::commentTable('alarm_group_phone', '告警通知组电话关联表');
    }
    ...
    {
        Schema::dropIfExists('alarm_group_phone');
    }
}
