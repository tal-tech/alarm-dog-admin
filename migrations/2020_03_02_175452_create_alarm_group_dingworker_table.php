...
class CreateAlarmGroupDingworkerTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('alarm_group_dingworker', function (Blueprint $table) {
        ...
        HelpersForMigration::commentTable('alarm_group_dingworker', '告警通知组钉钉工作通知关联表');
    }
    ...
    {
        Schema::dropIfExists('alarm_group_dingworker');
    }
}
