...
class CreateAlarmGroupEmailTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('alarm_group_email', function (Blueprint $table) {
        ...
        HelpersForMigration::commentTable('alarm_group_email', '告警通知组邮箱关联表');
    }
    ...
    {
        Schema::dropIfExists('alarm_group_email');
    }
}
