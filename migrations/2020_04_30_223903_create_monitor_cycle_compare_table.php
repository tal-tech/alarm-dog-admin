...
class CreateMonitorCycleCompareTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('monitor_cycle_compare', function (Blueprint $table) {
            ...
            $table->integer('compare_cycle', false, true)->default(0)->comment('参考对比周期，单位秒，可枚举');
        ...
        HelpersForMigration::commentTable('monitor_cycle_compare', '同比环比监控任务表');
    }
    ...
    {
        Schema::dropIfExists('monitor_cycle_compare');
    }
}
