...
class CreateAlarmGroupWechatTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('alarm_group_wechat', function (Blueprint $table) {
        ...
        HelpersForMigration::commentTable('alarm_group_wechat', '告警通知组微信关联表');
    }
    ...
    {
        Schema::dropIfExists('alarm_group_wechat');
    }
}
